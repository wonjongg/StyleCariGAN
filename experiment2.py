...
if __name__ == "__main__":
    ...
    Photo Generation
    '''
    utils.save_image(g_ema.photo_generator([sample_z])[0], os.path.join("experiment2_result/wcode",f'result_exp2_9_photo.png'),range=(-1, 1),normalize= True)
    # print(w)
    # print(w.shape)
    ...
    ## StyleCariGAN
    imga = g_ema([w], truncation = truncation, input_is_latent=True, truncation_latent= truncation_latent,mode= 'p2c', phi = phi)
    utils.save_image(imga['result'], os.path.join("experiment2_result/wcode",f'result_exp2_9.png'),range=(-1, 1))